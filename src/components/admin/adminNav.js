const icons = {
  ...
  finance: (
    <svg viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4 shrink-0">
      ...
      <path fillRule="evenodd" d="M10 1c-4.97 0-9 4.03-9 9s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9zm.75 3.75a.75.75 0 00-1.5 0v.316a4.63 4.63 0 00-1.253.339c-.265.122-.52.277-.744.468-.44.375-.813.949-.813 1.727 0 .577.19 1.049.44 1.401.245.345.552.594.83.775.531.346 1.178.556 1.54.667V13.5a2.16 2.16 0 01-.925-.437 1.05 1.05 0 01-.213-.243.75.75 0 10-1.28.784c.16.26.365.485.6.677.48.392 1.13.63 1.818.716v.253a.75.75 0 001.5 0v-.27a4.42 4.42 0 001.5-.484c.612-.4 1.15-1.07 1.15-2.07 0-1-.538-1.67-1.15-2.07a4.42 4.42 0 00-1.5-.484V6.51a2.02 2.02 0 01.65.316.75.75 0 00.918-1.186 3.52 3.52 0 00-1.568-.652V4.75z" clipRule="evenodd" />
    </svg>
  ),
  reports: (
    <svg viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4 shrink-0">
...
export const ADMIN_NAV_ITEMS = [
  ...
  },
  {
    ...
    children: [
      { href: "/admin/my-checklist", label: "Checklist" },
      { href: "/admin/my-performance", label: "Performance" },
  ...
  },
  {
    ...
    children: [
      ...
      { href: "/admin/curriculum", label: "Steps of Progression" },
      { href: "/admin/parent-involvement", label: "Parent Involvement" },
      { href: "/admin/checklists", label: "Checklist Manager" },
      {
        href: "/admin/teacher-training-pathways",
        label: "Staff Professional Development",
      },
      { href: "/admin/character-guide", label: "Character Guide" },
  ...
  },
  {
    ...
    children: [
      ...
      { href: "/admin/classroom-budgets", label: "Classroom Budgets" },
    ],
  },
  {
    href: "/admin/reports",
