export function PlayIcon({ className = "h-12 w-12" }) {
  return (
    <svg viewBox="0 0 48 48" className={className} fill="none">
      <circle cx="24" cy="24" r="23" fill="white" fillOpacity="0.9" stroke="currentColor" strokeWidth="2" />
...
export function RocketIcon({ className = "h-6 w-6" }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2">
...
export function BlocksIcon({ className = "h-6 w-6" }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2">
...
export function UploadIcon({ className = "h-8 w-8" }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2">
...
export function TruckIcon({ className = "h-6 w-6" }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <polygon strokeLinecap="round" strokeLinejoin="round" points="16 8 20 8 23 11 23 16 16 16 16 8" />
...
export function GraduationIcon({ className = "h-6 w-6" }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2">
      <path strokeLinecap="round" strokeLinejoin="round" d="M22 10l-10-6L2 10l10 6 10-6z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 12v5c0 2 3 4 6 4s6-2 6-4v-5" />
      <line strokeLinecap="round" x1="22" y1="10" x2="22" y2="16" />
    </svg>
  );
}

export function CreditCardIcon({ className = "h-6 w-6" }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2">
...
export function BabyIcon({ className = "h-6 w-6" }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2">
...
export function BuildingIcon({ className = "h-6 w-6" }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <line strokeLinecap="round" x1="9" y1="6" x2="9" y2="6.01" />
      <line strokeLinecap="round" x1="15" y1="6" x2="15" y2="6.01" />
      <line strokeLinecap="round" x1="9" y1="10" x2="9" y2="10.01" />
      <line strokeLinecap="round" x1="15" y1="10" x2="15" y2="10.01" />
      <line strokeLinecap="round" x1="9" y1="14" x2="9" y2="14.01" />
      <line strokeLinecap="round" x1="15" y1="14" x2="15" y2="14.01" />
      <path strokeLinecap="round" d="M9 22v-4h6v4" />
    </svg>
  );
}
