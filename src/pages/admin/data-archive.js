  ...
  return (
    <AdminLayout title="Data Archive">
      ...
      <Panel style={{ marginTop: 16 }}>
        ...
        {!centerId ? (
          <p style={{ color: "var(--admin-text-muted)" }}>Select a center to view archives.</p>
        ) : archives.length === 0 ? (
          <p style={{ color: "var(--admin-text-muted)" }}>No archives found.</p>
        ) : (
...
function pill(active) {
  return { fontSize: 11, padding: "3px 8px", borderRadius: 999, border: active ? "1px solid var(--admin-info-border)" : "1px solid var(--admin-border)", background: active ? "var(--admin-info-bg)" : "var(--admin-bg-tertiary)", color: active ? "var(--admin-info-text)" : "var(--admin-text-secondary)", fontWeight: 800 };
}
...
const miniBtn = { padding: "5px 8px", background: "var(--admin-bg)", color: "var(--admin-text)", border: "1px solid var(--admin-border)", borderRadius: 6, cursor: "pointer", fontWeight: 700, fontSize: 11 };
