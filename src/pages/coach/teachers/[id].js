...
export default function AdminTeacherDetail() {
  ...
  if (loading) {
    return (
      <CoachLayout title="Teacher Profile">
  ...
  return (
    <CoachLayout title={`Teacher: ${teacher.name || teacher.email}`}>
      <div className="flex flex-col gap-4">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <Link href="/coach/teachers" className="rounded-xl border border-gray-200 bg-white px-4 py-2 text-sm font-semibold text-gray-800 no-underline hover:bg-gray-50">
              Teacher Assignments
            </Link>
          </div>
          {error ? (
