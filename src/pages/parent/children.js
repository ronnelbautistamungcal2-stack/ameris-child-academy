        ...
        >
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              <span className="rounded-full border border-sky-100 bg-sky-50 px-2.5 py-1 text-[11px] font-extrabold uppercase tracking-[0.16em] text-sky-700 dark:border-sky-900/60 dark:bg-sky-950/40 dark:text-sky-200">
                {formatTime(activity.createdAt)}
              </span>
              <span className="rounded-full border border-gray-200 bg-gray-50 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-gray-600 dark:border-gray-700 dark:bg-slate-800 dark:text-gray-300">
                {dayPartLabel(activity.createdAt)}
              </span>
              <span className="rounded-full border border-gray-200 bg-gray-50 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.16em] text-gray-700 dark:border-gray-700 dark:bg-slate-800 dark:text-gray-200">
            ...
            <div className="mt-2 text-[15px] font-black tracking-tight text-gray-900 dark:text-gray-100">
            ...
            <div className="mt-1 flex flex-wrap items-center gap-x-2 gap-y-1 text-[12px] text-gray-500 dark:text-gray-400">
              ...
              <span>{describeActivitySummary(activity)}</span>
            </div>
